                ...
                return(
                    ...
                    <div className="checkRow">
                        ...
                        <div className="checkCol right-col">
                            ...
                            <Button variant="contained"  onClick={()=>handleClick(id,tableNo,time)}><MenuBookIcon color="action" style={{ fontSize: 30 , marginRight:"10"}}></MenuBookIcon>View Check</Button>
                        </div>
                    </div>
                    </div>
