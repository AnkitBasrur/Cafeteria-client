        ...
        <div style={{ marginLeft:"3%" }}>
            ...
            />
             ...
             <div className="pay-total">
                <Typography  variant="h5"  display="inline"> Pay For </Typography><Typography  display="inline" variant="h5" color="secondary">Rs. {initial}</Typography> <Button onClick={handleSubmit} variant="contained" style={{marginLeft:"10%"}}>Pay</Button>
            </div>
            </form>
        </div>
    )
